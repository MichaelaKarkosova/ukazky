...
function back(){
	location.href = "http://www.lupework.eu/"; 
}
function ranky(){
	location.href = "http://www.lupework.eu/ranks.php"; 
}
</script>
<?php
...
$GLOBALS['certifikacebody'] = 0;
 ...
 </form><input type='submit' class='button' name='zpet' value='Zpět' onClick='back();'>
...
//$modelc = preg_replace('/[^A-Za-z0-9\-]/', '', $modelc);
$modelc = str_replace(" - ", "", $modelc);
//$modelc = preg_replace('/\D/', '', $modelc);
...
function CW($cena,$kapacita){
 ...
 if ($cenazawatt > 8){
  ...
  else if ($cenazawatt <7.3  && $cenawatt > 6.7){
		 $GLOBALS['bodycw'] = 8;
		 	$cenawatt = 0;
  }
  else if ($cenazawatt <6.8  && $cenawatt > 6){
		 $GLOBALS['bodycw'] = 7;
		 	$cenawatt = 0;
  }
  else if ($cenazawatt <6.1 && $cenawatt > 5.4){
		 $GLOBALS['bodycw'] = 6;
		 	$cenawatt = 0;
  }
  else if ($cenazawatt <5.5  && $cenawatt > 4.2){
		 $GLOBALS['bodycw'] = 5;
		 	$cenawatt = 0;
  }
  else if ($cenazawatt <4.3  && $cenawatt > 3){
		 $GLOBALS['bodycw'] = 4;
		 	$cenawatt = 0;
	 }
  else if ($cenazawatt <3.1 && $cenawatt > 2.7){
		 $GLOBALS['bodycw'] = 3;
		 	$cenawatt = 0;
  }
  else if ($cenazawatt <2.8 && $cenawatt > 2){
	  		 $GLOBALS['bodycw'] = 2;
		 	$cenawatt = 0;
	  }
 else{
