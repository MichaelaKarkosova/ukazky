...
{
   window.location.href = "http://lupework.eu/rate.php";
}
    ...
    $( "#dialog-confirm" ).dialog({
      ...
      buttons: {
        "Odstranit desku": function() {
          window.location.href = "http://lupework.eu/clearmb/"; 
        },
        "Odstranit procesor": function() {
          window.location.href = "http://lupework.eu/clearcpu/"; 
        }
      }
    });
  } );
...
$result = $conn->query($sql);
	header ('Location: http://lupework.eu/');
